...
<head>
    ...
    <meta property="og:image" content="http://www.mostech.ae/img/fav.png" />
    ...
    <meta name="twitter:creator" content="@mostech.ae" />
	...
	<section class="page-header page-header-custom-background" style="background-image: url(../img/custom-header-bg.jpg);">
					...
					<div class="row mb-xlg">
						...
						<p  align="justify">We partner with global ERP leaders to deliver solutions trusted by enterprises worldwide, helping you leverage cutting-edge technology without compromise.</p>
								 <a href="contact.php" <span class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="600">  <a href="contact.php" data-hash class="btn btn-tertiary mr-md appear-animation mt-4" data-appear-animation="fadeInDown" data-appear-animation-delay="300"  style="background:#020c4c;">CONTACT US FOR DEMO</a>
							
							</p>
						</div>
						<div class="col-sm-6">
							<img class="img-responsive mt-xlg" src="../img/erp1.gif" alt="">
						</div>
					</div>			
					</div>
...
<br>
                    ...
                    <div class="col-sm-4">
                        <img class="img-responsive" src="../img/erp6.png" alt="">
                    </div>
                ...
                <div class="row mt-4">
                    <div class="col-sm-4">
                        <div class="feature-box">
                            ...
                            <div class="feature-box-info">
                                <h4 class="heading-primary mb-none">ERP Implementation & Customization </h4>
                    ...
                    <div class="col-sm-4">
                        <div class="feature-box">
                            ...
                            <div class="feature-box-info">
                                <h4 class="heading-primary mb-none">Integration with Existing Systems </h4>
                    ...
                    <div class="col-sm-4">
                        <div class="feature-box">
                            ...
                            <div class="feature-box-info">
                                <h4 class="heading-primary mb-none">Training & Support</h4>
...
With MOSTECH, you don’t just get software — you get a strategic partner for digital transformation.					</p>
                        ...
                        <div class="col-sm-4">
                            <img class="img-responsive mt-xlg" src="../img/mos-img5.jpeg" alt="">
                        </div>
					</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <h2 class="heading-primary">
                                <font color="#020c4c">  <strong>Build a Smarter Business with Global ERP Solutions</strong></font>
                            </h2>


<p style="color:#000;">We help organizations implement, optimize, and scale ERP systems that are trusted worldwide. From small enterprises to large corporations, our ERP solutions enhance operational efficiency, reduce errors, and provide actionable insights across departments.</p>
                            <p class="heading-primary">
                                <div class="row">
                                    <div class="col-xs-12 col-md-12">
                                        <ul class="list list-icons list-primary">
										<li class="appear-animation animated fadeInUp appear-animation-visible" style="margin-bottom:5px!important;padding-left:16px!important;" data-appear-animation="fadeInUp" data-appear-animation-delay="600" style="animation-delay: 600ms;"><i class="fa fa-caret-right left-10"></i> Talk to Our ERP Experts Today</li>
										<li class="appear-animation animated fadeInUp appear-animation-visible" style="margin-bottom:5px!important;padding-left:16px!important;"  data-appear-animation="fadeInUp" data-appear-animation-delay="900" style="animation-delay: 900ms;"><i class="fa fa-caret-right left-10"></i> Choose the Right ERP Platform for Your Business</li>
									</ul>
                                    </div>
                                </div>
