...
$pageDescription = 'The page you are looking for doesn\'t exist or may have been moved.';
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-not-found-main">
                        ...
                        <h3 class="mt-lg mb-sm" style="font-weight: 700; color: #111;">Page Not Found</h3>
                        <p class="lead" style="color: #666; max-width: 600px; margin: 0 auto 30px;">The page you are looking for doesn't exist or may have been moved.</p>
