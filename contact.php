    ...
    <head>
        ...
        <link rel="canonical" href="https://mostech.ae/contact" />
    ...
    <body>
        ...
        <div role="main" class="main">
            ...
            <div class="responsive-map-container">
                ...
                <div class="col-md-12">
                   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3610.5938115827043!2d55.27031837620187!3d25.183189632266426!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6964a5ad0fb5%3A0x37e86857219ea19b!2sMostech%20Business%20Solutions!5e0!3m2!1sen!2sae!4v1768653677929!5m2!1sen!2sae" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div style="padding-top:40px;padding-bottom:20px;">
                                    <font color="green"><strong>Thank you!</strong> Your message has been sent successfully.</font>
                                    </div>
                            <?php elseif (isset($_GET['status']) && $_GET['status'] == 'error'): ?>
                                     <div style="padding-top:40px;padding-bottom:20px;">
                                    <font color="red">Oops! Something went wrong. Please try again.</font>
                                    </div>
                            <?php endif; ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <p align="justify">Mostech Business Solutions is a Dubai-based software company trusted across the UAE and GCC producing world-class quality Softwares, Websites, Web Applications & Mobile Applications. </p>
                            <div class="col-md-6">
                                <h4 class="heading-primary"> <strong>Dubai </strong>Office</h4>

                                <p><i class="fa fa-map-marker"></i> <strong>Bay Square Business Tower</strong><br> Business Bay, Dubai, UAE </p>
                                <p><i class="fa fa-phone"></i> (+971) 581730112
                                <!--<br><i class="fa fa-phone"></i> (+971) 585792020</p>-->

                            </div>
                            <div class="col-md-6">
                                <h4 class="heading-primary"> <strong>Kannur </strong>Office</h4>
                                <p><i class="fa fa-map-marker"></i> <strong> KVR Tower, Caltex</strong><br> Kannur, Kerala, India </p>
                                <p><i class="fa fa-phone"></i>  (+91) 8547557283
                                <!--<br><i class="fa fa-phone"></i>  (+91) 8891314424</p>-->
                            </div>
                              

                            <h4 class="heading-primary">Business <strong>Hours</strong></h4>
                            <ul class="list list-icons list-dark mt-xlg">
                                <li><i class="fa fa-clock-o"></i> Monday to Friday - 9 AM to 6 PM</li>
                                <li><i class="fa fa-clock-o"></i>Saturday to Sunday - Closed</li>
                            </ul>
