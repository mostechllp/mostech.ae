    ...
    <head>
        ...
        <title>Certified CCTV Installation Company in Dubai, UAE - Mostech</title>
        ...
        <meta name="description" content="Certified CCTV security system installation in Dubai. Mostech supplies high-definition surveillance cameras and security monitoring for commercial properties." />
	...
	<section class="page-header page-header-custom-background" style="background-image: url(img/custom-header-bg.webp);">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h1>CCTV Solutions<span> Security Systems </span></h1>
					...
					<div class="row mb-xlg">
						<div class="col-md-6">
						<h2><strong class="heading-primary">We are </strong>CCTV EXPERTS</h2>					
						<p class="mt-xlg" align="justify"  style="color:#000;">Simplifying technology has always been a core philosophy at MOS. We provide scalable and intelligent monitoring solutions that incorporate high-resolution CCTV cameras for enhanced image quality at low bandwidth, Optimized storage, Coupled with intelligent digital recording and analysis. We offer these solutions with robust communication backbone over Fibre optic, LAN, Wireless and other technologies based on the requirement and existing infrastructure availability, along with options of remote monitoring and recording,including Cloud solutions. We provide a range of protection from internal and external theft, health & safety issues, racking damage, increased productivity, bullying in the workplace to compensation claims and more.</p> 
						</div>
						<div class="col-md-6">
							<img class="img-responsive mt-xlg" src="img/cctv4.gif" alt="">
						</div>
						<div class="container">
						<p class="mt-xlg" align="justify"  style="color:#000;">
							 If you are looking for the best security camera systems for your Organisations, Institutions, Home, Residential complexes etc, then MOS is the name to rely on. Precarious incidences reported in recent times As triggered security concerns. Everyone are looking for feasible surveillances solution, that can address their security concerns and offer total peace of mind. MOS renowned for its CCTV solutions, offers a wide range of products and services.
							 </p>
		<p class="mt-xlg" align="justify" style="color:#000;">Looking for reliable home security systems? Get in touch with our MALABAR ONLINE SOLUTIONS, and we will help you secure your premise at best. <a href="contact.php" <span class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="600">  <a href="contact.php" data-hash class="mt-4 btn btn-tertiary mr-md appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="300" style="background:#020c4c;">CONTACT US &nbsp;<i class="fa fa-whatsapp"></i> </a>
							</div>
	</p> 	
	</div>	</div>
		...
		<hr>
						...
						<div class="container">
							...
							<div class="col-md-12 center">
								<h2>Our <strong class="heading-primary">Services</strong></h2>
							<p align="center" style="color:#000;">When it comes to security, it is not wise to try amateurs. Seek assistance from MOS, one of the expert security and surveillance service providers in Kannur. MOS is committed to reinforce your security by providing a variety of services including CCTV installation,cctv installation classes,repair service and cabling needed for the entire CCTV setup. With experienced professionals and state-of-the-art amenities, MOS is on the forefront to serve you and make your life more secure than ever.</p></div>
						</div>
						<hr>
						<div class="row">
						...
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2">
								...
								<i class="icon-screen-desktop icons text-12"></i>

								<!--<img class="img-responsive mb-lg" src="img/hd.png" alt="">-->
								</div>
								<div class="feature-box-info">
									<h6 class="mb-xs"><font color="#020c4c"><b>High Quality</b></font></h6>
										<p align="justify"> MOS Uses Only HD Camera & DVR Systems</p>	</div>
							</div>
							</div>
							<div class="col-md-4">
							<div class="feature-box feature-box-style-2">
								<div class="feature-box-icon">
								    <i class="icon-badge icons text-12"></i>    

								<!--<img class="img-responsive mb-lg" src="img/service.png" alt="">-->
								</div>
								<div class="feature-box-info">
								<h6 class="mb-xs"><font color="#020c4c"><b>Best Services</b></font></h6>
							<p align="justify">MOS Gives You Best Ever Service At Any Time</p>							
							</div>
							</div>
							</div>
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2">
								<div class="feature-box-icon">
								    <i class="icon-control-play icons text-12"></i>
								<!--<img class="img-responsive mb-lg" src="img/online.png" alt="">-->
								</div>
								<div class="feature-box-info">
									<h6 class="mb-xs"><font color="#020c4c"><b>Watch Online</b></font></h6>
								
						<p align="justify">MOS Helps You To Watch Footages Online</p>	</div>
							</div>
							</div>	
							</div>
						...
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2">
								<div class="feature-box-icon">
								    <i class="icon-microphone icons text-12"></i>
								<!--<img class="img-responsive mb-lg" src="img/audio.png" alt="">-->
								</div>
								<div class="feature-box-info">
									<h6 class="mb-xs"><font color="#020c4c"><b>Audio Recording </b></font></h6>
									<p align="justify">MOS Gives You Advanced Recoding Devices</p>
									</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2">
								<div class="feature-box-icon">
								    <i class="icon-rocket icons text-12"></i>
								<!--<img class="img-responsive mb-lg" src="img/latest.png" alt="">-->
								</div>
								<div class="feature-box-info">
								<h6 class="mb-xs"><font color="#020c4c"><b>Latest Technologies </b></font></h6>
										<p align="justify">MOS Uses Only Water Resistant Devices</p>
										</div>
							</div>
							</div>
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2">
								<div class="feature-box-icon">
								    <i class="icon-magic-wand icons text-12"></i>
						<!--<img class="img-responsive mb-lg" src="img/easy.png" alt="">-->
								</div>
								<div class="feature-box-info">
								<h6 class="mb-xs"><font color="#020c4c"><b>Easy Operations </b></font></h6>
								<p align="justify">MOS Gives You Simplified Solutions</p>
								</div>
							</div>
						</div>
					</div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <ul class="list list-icons list-icons-sm">
                                    ...
                                    <li><i class="fa fa-caret-right"></i> <a href="hosting&domain.php">HOSTING</a></li>
                                     ...
                                     <!--<li><i class="fa fa-caret-right"></i> <a>PRINTING</a></li>-->

                                        <!--<li><i class="fa fa-caret-right"></i> <a>GRAPHICS </a></li>-->
                            ...
                            <div class="col-md-2">
                                ...
                                <ul class="list list-icons list-icons-sm">
                                    ...
                                    <!--<li><i class="fa fa-caret-right"></i> <a>BLOG</a></li>-->
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="social-icons footer-social-icons">
                            ...
                            <li class="social-icons-twitter"> <a href="https://www.twitter.com/mostechllc" title="Twitter"><i class="fa fa-twitter"></i></a></li>
